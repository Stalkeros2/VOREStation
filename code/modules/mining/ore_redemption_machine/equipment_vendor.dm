...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Ale",						        /obj/item/weapon/reagent_containers/food/drinks/bottle/small/ale,       125),
		...
		new /datum/data/mining_equipment("Space Cash",					/obj/item/weapon/spacecash/c1000,									1000),
